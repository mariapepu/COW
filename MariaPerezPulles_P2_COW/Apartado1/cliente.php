          ...
          <form action="./servidor.php" method="POST">
            <div class="form-group">
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control" placeholder="Introduce una ciudad, pueblo o lugar de interés"
              ...
              <div class="form-group">
                <div class="input-group mb-2">
                  ...
                  <select id="inputState" class="form-control" placeholder="Número de personas" name="guests">
